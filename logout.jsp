<!-- $Header: /u02/cvsroot/hockeystats/logout.jsp,v 1.1 2002/09/15 01:53:23 tom Exp $ -->

<HTML>
<TITLE>Jon's AHL - Logged Out</TITLE>
<BODY TEXT="black" LINK="blue" BGCOLOR="FFFFFF">
<%
  session.removeAttribute("isAdmin");
  session.removeAttribute("userOID");
...
<HEAD><CENTER><H1>You have been logged out.</H1></CENTER></HEAD>
